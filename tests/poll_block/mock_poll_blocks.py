...
simple_poll_expired = (
    ...
    objects.poll_block.PollBlock(
        **basic_poll_data[1], creation_timestamp=1672531220, expires_after=604800
    ),
    dominate.tags.section(
        ...
        dominate.tags.footer(
            dominate.tags.div(
                dominate.tags.span(
                    "Ended on: ", HTMLTimeTag("2023-01-08 00:00:20", datetime="2023-01-08T00:00")
                ),
                cls="poll-metadata",
            ),
        ),
...
simple_ongoing_poll = (
    ...
    objects.poll_block.PollBlock(
        **basic_poll_data[1], creation_timestamp=1672531200, expires_after=604800
    ),
    dominate.tags.section(
        dominate.tags.header(dominate.tags.h3("This is a question")),
        dominate.tags.div(
        ...
        dominate.tags.footer(
            dominate.tags.div(
                dominate.tags.span(
                    "Remaining time: ", HTMLTimeTag("7 days, 0:00:00", datetime="P7D")
                ),
                cls="poll-metadata",
            ),
        ),
