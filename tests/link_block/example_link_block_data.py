...
def format_constructor(url, *children):
    return dominate.tags.div(
        dominate.tags.div(
            dominate.tags.a(*children, href=url, cls="link-block-link"), cls="link-block"
        ),
        cls="post-body",
    )
...
link_block_with_site_name = (
    ...
    format_constructor(
        ...
        dominate.tags.div(
            dominate.tags.div(
                dominate.tags.span(dominate.tags.span("Example Domain")), cls="link-block-subtitles"
            ),
            cls="link-block-description-container",
        ),
    ),
...
link_block_with_site_name_and_author = (
    ...
    [
        objects.link_block.LinkBlock(
            url="https://example.com", site_name="Example Domain", author="Example Author"
        )
    ],
    format_constructor(
        "https://example.com",
...
link_block_with_all = (
    ...
    format_constructor(
        ...
        dominate.tags.div(
            ...
            dominate.tags.div(
                dominate.tags.span("Example Domain"), cls="link-block-title poster-overlay-text"
            ),
            cls="poster-container",
        ),
        dominate.tags.div(
