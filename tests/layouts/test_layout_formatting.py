...
def test_basic_layout_with_truncate_format():
    helper_function(
        ...
        data.basic_rows_layout_with_truncate_example[2],
    )
...
def test_layouts_with_ask_section_and_truncation_format():
    helper_function(
        ...
        data.layouts_with_ask_section_and_truncation[2],
    )
...
def test_layouts_in_content_with_lists_format():
    helper_function(
        data.layouts_in_content_with_lists[0],
        data.layouts_in_content_with_lists[2],
        data.with_list_content_list,
    )
