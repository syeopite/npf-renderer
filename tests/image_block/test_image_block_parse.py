...
def test_image_block_with_color_attr_parse():
    helper_function(
        test_data.image_block_with_color_attr[0], test_data.image_block_with_color_attr[1]
    )


def test_gif_image_block_with_poster_parse():
    helper_function(
        test_data.gif_image_block_with_poster[0], test_data.gif_image_block_with_poster[1]
    )
...
def test_image_block_with_app_attribution():
    helper_function(
        test_data.image_block_with_app_attribution[0], test_data.image_block_with_app_attribution[1]
    )
