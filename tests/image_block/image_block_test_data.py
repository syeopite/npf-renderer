...
gif_image_block_with_post_attribution = (
    ...
    [
        objects.image.ImageBlock(
            media=[
                objects.media_objects.MediaObject(
                    url="https://64.media.tumblr.com/s400x600/blahblahblah.gifv", width=357, height=174
                ),
                objects.media_objects.MediaObject(
                    url="https://64.media.tumblr.com/s250x400/blahblahblah.gifv", width=250, height=122
                ),
            ],
            ...
            attribution=objects.attribution.PostAttribution(
                ...
                blog=objects.attribution.BlogAttribution(
                    name="example-blog", url="https://example-blog.tumblr.com", uuid="t:SX31hFaWHA_312_df"
                ),
            ),
        )
    ],
...
image_block_with_app_attribution = (
    [
        ...
        },
        {
            ...
            "formatting": [{"type": "link", "start": 61, "end": 88, "url": "https://twitter.com/example"}],
        },
        {
            "type": "image",
            "media": [
    ...
    [
                ...
                objects.inline.StyleInterval(
                    ...
                    instructions=[
                        objects.inline.LinkInstruction(
                            type_=objects.inline.FMTTypes.LINK, url="https://twitter.com/example"
                        )
                    ],
                )
            ],
        ...
        objects.image.ImageBlock(
            ...
            attribution=objects.attribution.AppAttribution(
                url="https://twitter.com/example/status/1234567", app_name="Twitter", display_text="View on Twitter"
            ),
        ),
    ],
    dominate.tags.div(
