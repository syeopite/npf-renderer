...
def test_image_block_with_color_attr_format():
    helper_function(
        test_data.image_block_with_color_attr[0], test_data.image_block_with_color_attr[2]
    )
...
def test_gif_image_block_with_poster_format():
    helper_function(
        test_data.gif_image_block_with_poster[0], test_data.gif_image_block_with_poster[2]
    )
...
def test_gif_image_block_with_link_attribution_format():
    helper_function(
        test_data.gif_image_block_with_link_attribution[0],
...
def test_gif_image_block_with_post_attribution_format():
    helper_function(
        test_data.gif_image_block_with_post_attribution[0],
...
def test_image_block_with_app_attribution_format():
    helper_function(
        test_data.image_block_with_app_attribution[0], test_data.image_block_with_app_attribution[2]
    )


def test_if_cropped_images_are_skipped():
    helper_function(
        test_data.skips_cropped_image_block_test[0], test_data.skips_cropped_image_block_test[1]
    )
