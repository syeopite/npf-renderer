...
def test_can_parse_basic_audio_block():
    return helper_function(
        mock_audio_blocks.basic_audio_block[0], mock_audio_blocks.basic_audio_block[1]
    )


def test_can_parse_audio_block_with_title():
    return helper_function(
        mock_audio_blocks.audio_block_with_title[0], mock_audio_blocks.audio_block_with_title[1]
    )
...
def test_can_parse_audio_block_with_metadata():
    return helper_function(
        ...
        mock_audio_blocks.audio_block_with_metadata[1],
    )


def test_can_parse_audio_block_with_poster():
    return helper_function(
        mock_audio_blocks.audio_block_with_poster[0], mock_audio_blocks.audio_block_with_poster[1]
    )
...
def test_can_parse_embedded_audio_block():
    return helper_function(
        ...
        mock_audio_blocks.audio_block_embed_spotify_test[1],
    )
