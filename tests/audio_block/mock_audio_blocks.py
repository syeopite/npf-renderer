...
MEDIA = {
    ...
    "formatted": dominate.tags.source(
        src="https://a.tumblr.com/someaudiosource.mp3", type="audio/mpeg"
    ),
}
...
basic_audio_block = (
    ...
    dominate.tags.section(
        dominate.tags.audio(MEDIA["formatted"], controls=True), cls="ap-container"
    ),
)
...
forbid_external_iframes_fallback_test = (
    ...
    dominate.tags.div(
        dominate.tags.div(
            dominate.tags.a(
                dominate.tags.div(
                    dominate.tags.span("Embeds are disabled"), cls="link-block-title"
                ),
                dominate.tags.div(
                    dominate.tags.p(
                        "Please click me to listen on the original site",
                        cls="link-block-description",
                    ),
                    dominate.tags.div(
                        dominate.tags.span(dominate.tags.span("spotify")),
        ...
        dominate.tags.div(
            dominate.tags.a(
                ...
                dominate.tags.div(
                    ...
                    dominate.tags.div(
                        dominate.tags.span(dominate.tags.span("on.soundcloud.com")),
                        cls="link-block-subtitles",
                    ),
                    cls="link-block-description-container",
                ),
        ...
        dominate.tags.div(
            dominate.tags.a(
                ...
                dominate.tags.div(
                    ...
                    dominate.tags.div(
                        dominate.tags.span(dominate.tags.span("a.tumblr.com")),
                        cls="link-block-subtitles",
                    ),
                    cls="link-block-description-container",
                ),
...
audio_block_fallback_with_only_media_url_and_provider = (
    {
        "type": "audio",
        "provider": "tumblr",
        "media": {"url": "https://on.soundcloud.com/medialink"},
    },
    [
        objects.audio_block.AudioBlock(
            provider="tumblr",
            media=[
                objects.media_objects.MediaObject(
                    url="https://on.soundcloud.com/medialink", width=540, height=405
                )
            ],
        )
    ],
